...
| **Nhiệt độ hoạt động** | Theo thông số module GP-02 |
...
Module xuất dữ liệu theo chuẩn **NMEA0183**, bao gồm các bản tin phổ biến như:
...
Các thư viện Arduino như **TinyGPSPlus**, **NeoGPS** hoặc **MicroNMEA** đều hỗ trợ đọc và xử lý trực tiếp các bản tin này.
...
- Số lượng vệ tinh thu được.
- Điều kiện thời tiết.
- Vật cản giữa anten và bầu trời.
- Hiện tượng phản xạ tín hiệu (Multipath).
- Chất lượng anten GPS.
